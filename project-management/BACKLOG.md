...
| **Supervised Authoring (Epic 11)** | **17** | **3** | **14** | **~61** |
| **Total** | **74** | **59** | **15** | **~66** |
...
**Velocity**: 360 SP completed across 12 epics (Epic 11: ADR-006/007 + AUTHOR-001 + AUTHOR-002 = 17 SP done on 2026-08-19). Remaining: PUBLISH-002 (5 SP) + Epic 11 (~61 SP).
