...
| **Supervised Authoring (Epic 11)** | **17** | **6** | **11** | **~50** |
| **Total** | **74** | **62** | **12** | **~55** |
...
**Velocity**: 373 SP completed across 12 epics (Epic 11: ADR-006/007 + AUTHOR-001 + AUTHOR-002 = 17 SP on 2026-08-19; AUTHOR-003 = 5 SP and AUTHOR-004 = 5 SP on 2026-08-21; AUTHOR-005 = 3 SP on 2026-08-24). Remaining: PUBLISH-002 (5 SP) + Epic 11 (~50 SP).
