...
| AUTHOR-003 | Brief model + Generate modal rework | Done (PR pending → develop, 2026-08-21; migration `b3c7e1f9a2d4`) | `feature/AUTHOR-003-brief` | [plan](../docs/superpowers/plans/2026-08-20-author-003-brief.md) | ADR-007; review §6 #3 |
