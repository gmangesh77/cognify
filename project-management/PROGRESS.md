...
| AUTHOR-004 | Per-section regenerate (+ L-013 section-id contract fix) | Done (PR pending → develop, 2026-08-21; **grew 3 → 5 SP**: every existing edit/rewrite/history flow addressed the wrong section, fixed at the root as Task 1) | `feature/AUTHOR-004-section-regenerate` | [plan](../docs/superpowers/plans/2026-08-21-author-004-section-regenerate.md) | program plan §5.5; review §6 #4 |
