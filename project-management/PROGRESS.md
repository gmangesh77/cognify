...
| VISUAL-008  | Phase 5 — Frontend Visual Studio (chip rails, spec cards, HTML refine, gallery)                      | In Progress | `claude/vibrant-chatterjee-1115a8` (worktree)       | [plan](../docs/superpowers/plans/2026-05-06-visual-generation-improvement-plan.md) §11.5 | [brief](../docs/superpowers/specs/2026-05-06-visual-studio-pencil-design-brief.md) — **core slice landed**: API client + style cache + SpecCard / StyleChipRail / UsageBadge / SectionHtmlRefinePanel / VisualStudio. Remaining: SavedAssetGallery, image-import modal, article-detail mount, Playwright E2E, `enable_image_planner=True` flip. |
