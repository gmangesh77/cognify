...
| Pipeline Debug UI (AB#16789) | In Progress | 2026-04-02 | Full pipeline observability: `llm_calls` table + TrackedChatModel wrapper (captures all 13 LLM call sites via contextvars), debug API endpoints, /pipeline-debug page with step timeline + expandable LLM prompt/response viewer. Branch: `feature/pipeline-debug-ui`. [plan](../.claude/plans/sorted-mapping-floyd.md) |
| Dashboard & Research Fixes (AB#16748, AB#16749, AB#16751) | In Progress | 2026-04-06 | Trend registry rebuilt after key resolution (fixes NewsAPI 401), dashboard metrics return real published/research counts, Knowledge Base panel fetches aggregated stats from new `/metrics/knowledge-base` endpoint. Branch: `fix/16748-16749-16751-dashboard-research-apikeys` |
