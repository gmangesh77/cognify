...
**Next action:** AUTHOR-004 (per-section regenerate — program plan §5.5), then AUTHOR-005/INFRA-007. Live smoke of outline gate + brief flow passed 2026-08-21 (needed PR #75: `research_sessions.status` widened to 40 chars). PUBLISH-002 (WordPress, 5 SP) still open.
